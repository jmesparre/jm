...
<div className='relative pointer-events-none  ml-[6%] sm:ml-[39%] md:ml-[40%] sm:pb-0 sm:absolute top-[28vh] sm:top-[22%] md:top-[30vh] w-[80%] sm:w-[48%] md:w-[48%] lg:w-[46%]'>
            <h1 className='font-title max-w-lg  text-5xl sm:text-5xl md:text-6xl pb-4 sm:pb-0 '>Diseño y Desarrollo Web a medida</h1>
            <h2 className=' pb-4 max-w-lg  sm:pb-2  mt-[1%] sm:mt-5 text-sm sm:text-1xl md:text-base lg:text-base'>
              Hola me llamo Juan. Soy diseñador y desarrollador web con más de 10 años de experiencia, creo soluciones digitales a medida: desarrollo web , e-commerce, branding y estrategias SEO. Mi objetivo es potenciar tu presencia online.
            </h2>
