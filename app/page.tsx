  ...
  return (
    <main>
      <section id="home" className="hero ">
        <div className='z-5 relative sm:absolute top-[19vh] sm:top-[25%] md:top-[30vh] lg:top-[22vh] left-[5%]  md:left-[11%] xl:left-[20%]  sm:w-[178px] sm:h-[280px] w-[216px] h-[340px] md:w-[216px] md:h-[340px] lg:w-[261px] lg:h-[410px]'>
          <TiltedCard
        ...
        <div className='relative  ml-[6%] sm:ml-[39%] md:ml-[40%] pb-20 sm:pb-0 sm:absolute top-[20vh] sm:top-[22%] md:top-[30vh] w-[80%] sm:w-[48%] md:w-[48%] lg:w-[46%]'>
             ...
             <div className="pb-20 flex flex-wrap items-center  gap-2 md:flex-row  mt-[1%] sm:mt-5  w-[100%] sm:w-[40%] text-sm sm:text-1xl md:text-base">
              <Button className='bg-primary z-5 cursor-pointer group' variant="outline" size="sm">
                <ArrowRight
                  ...
                  />
                Escribime
                <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 32.7 32.9" className="ml-2 h-4 w-4">
